const quizQuestions = {
    "Financial Accounting": [
        {
            question: "Which financial statement summarizes a company's revenues and expenses?",
            options: ["Balance Sheet", "Income Statement", "Cash Flow Statement", "Statement of Retained Earnings"],
            correct: 1
        },
        {
            question: "What is the primary purpose of the trial balance?",
            options: [
    ...
    "Management Accounting": [
        {
            question: "Which costing method assigns overhead costs based on activities?",
            options: ["Absorption Costing", "Activity-Based Costing", "Variable Costing", "Marginal Costing"],
            correct: 1
        },
        {
            question: "What is a budget that adjusts for changes in activity levels?",
            options: ["Static Budget", "Flexible Budget", "Master Budget", "Capital Budget"],
            correct: 1
        },
    ],
    "Auditing": [
        {
            question: "What is the primary goal of an external audit?",
            options: [
                "To detect fraud",
        ...
        {
            question: "Which principle ensures that audit evidence is reliable?",
            options: ["Independence", "Professional Skepticism", "Audit Sampling", "Objectivity"],
            correct: 3
        },
    ]
};
